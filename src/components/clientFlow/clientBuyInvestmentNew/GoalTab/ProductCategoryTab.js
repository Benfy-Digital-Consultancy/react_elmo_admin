...
const ProductCategoryTab = ({ userOptions = [] ,getInvestmentPlanActionApi}) => {
  ...
  return (
    <React.Fragment>
      {userOptions
        .filter((x) => x.Label === "Product Categories")
        .map(({ DataInput }) =>
...
export default connect(null, mapDispatchToProps)(ProductCategoryTab);
